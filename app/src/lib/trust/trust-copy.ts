...
export const TRUST_ABOUT_SERVICE = {
  heading: "生活再建ナビについて",
  body: [
    "熊本地震で被災された方が、「この先どうすればいいのか」という不安を、ひとりで抱え込まなくてよいように、次に確認することを順番に整理する無料の案内です。",
...
export const TRUST_DEVELOPER = {
  ...
  body: [
    "熊本で学びながら、被災地でのボランティアなどにも関わっています。",
  ],
} as const;
...
export const TRUST_CONTINUITY_SUPPORT = {
  ...
  body: [
    ...
    "続けていくために、活動費のご支援（任意）がとても助かります。金額はお好きなもので大丈夫です。",
    "スマホなら Apple Pay・PayPay・クレジットカードで簡単に送れます。",
  ],
  ...
  formLead:
    "応援のメッセージも送れます（任意）。メッセージが多くなるとサーバーへの負担が増え、すぐにお返事できないことがあります。改善のご意見は上の「改善の声」へ。",
} as const;
...
export const TRUST_FAQ_OPERATOR_ANSWER =
  "熊本で学ぶ田辺 優（たなべ ゆう）が、被災地でのボランティアなどを通じて感じた課題をもとに作っています。詳しくは「その他」→「このサービスについて」をご覧ください。";
