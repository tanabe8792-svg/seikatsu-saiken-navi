...
const GUIDES: Record<string, ActionWalkthrough> = {
  ...
  "rw-j03-cert-prep": {
    ...
    plainTitle: "罹災証明書の申請",
    explanation:
      "罹災証明書は、市町村が「住家の被害の程度」を公的に証明する書類です。生活再建の支援金や、保険・自治体手続きのときに必要になることがあります。「半壊」「一部損壊」などの判定が付きます。申請はお住まいの市町村の窓口、またはオンライン申請で行います。",
    whyNow:
      "支援制度の多くが、この証明書（または申請中であること）を前提にしています。ただし受付期間は市町村ごとで、避難中や状況整理の途中でも焦らなくて大丈夫です。安全が取れてから、公式の受付案内を確認しましょう。",
    steps: [
      {
        id: "cert-understand",
        title: "何のための書類かを把握する",
    ...
    afterThis:
      "申請後は調査・判定を待ちます。日数は保証できません。待つあいだも、やること一覧の「いま確認する」から続けられます。証明書が届いたら生活再建支援や保険など次の手続きに使います。",
    tip: "混雑が予想されるときは、オンライン申請や時間帯をずらす・代理申請の可否を公式案内で確認すると負担が減ります。車が使えなくなった場合も、同じ罹災証明が免許・車庫・自動車税の手続きで先に必要になることがあります（ページ下の「車が使えなくなった」を参照）。",
  },
  "rw-j04-insurance-report": {
    actionId: "rw-j04-insurance-report",
    plainTitle: "保険会社へ被害を連絡する",
    explanation:
      "火災保険・地震保険などに入っている場合、契約している保険会社（または代理店）へ「地震で被害があった」と早めに伝えます。請求そのものより先に「事故報告・相談」の連絡から始めることが多いです。契約内容や必要書類は会社ごとに異なります。",
    whyNow:
  ...
  "rw-j02-water-station": {
    ...
    afterThis:
      "水の確保と並行して、被害写真・罹災証明など再建の確認にも進めます。減免は忘れずに。",
  ...
  "rw-j04-programs": {
    ...
    explanation:
      "国の制度以外にも、県や市町村の独自支援、見舞金、物資、相談窓口があります。住んでいる地域の「被災者支援」まとめページや支援ナビを中心に、自分の状況に合いそうなものを書き出します。住まいだけでなく、仕事・学校・通院の再開に関係する案内も、見落としやすいのでメモしておきましょう。",
    whyNow:
...
function defaultWalkthrough(actionId: string, title: string): ActionWalkthrough {
  return {
    ...
    plainTitle: title,
    explanation:
      "この手順では、いまの状況に合わせて確認すべきことを進めます。急がなくて大丈夫です。分かるところから進めてください。",
