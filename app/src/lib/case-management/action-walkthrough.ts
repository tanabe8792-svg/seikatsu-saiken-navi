  ...
  "rw-j03-photo": {
    ...
    steps: [
      ...
      },
      {
        id: "photo-order",
        title: "撮る順番を決める",
        body: "①建物の外観 → ②壊れた場所、の順が分かりやすいです。暗い場所は明かりを使ってください。下の「カメラで撮る」を押すと、撮った写真はこの端末に自動で残ります。",
        memoLabel: "メモ",
  ...
  "rw-j03-cert-prep": {
    ...
    steps: [
      ...
      },
      {
        id: "cert-apply",
        title: "申請する",
        body: "オンラインまたは窓口で申請します。窓口では、係の案内に従って進めてください（このナビは行政と連携していないため、画面を見せても手続きは自動では進みません）。終わったら受付番号・申請日をメモし、下の「完了する」で申請済みにできます。そのあとは「申請後の進み具合」で、いま何を待っているかを残せます。",
        memoLabel: "申請の記録",
  ...
  "rw-j05-emergency-repair": {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "上の「申請案内」から、県のブルーシート等（緊急修理）や市の案内、支援ナビを直接開けます。罹災証明が不要な緊急修理もあります。対象・期限は公式の案内で確認してください。",
        memoLabel: "案内の確認メモ",
