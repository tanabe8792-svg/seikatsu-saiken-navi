...
export function addEvidenceToCaseFile(
  ...
  let updated: CaseFile = {
    ...
    workerMessage: input.procedureId
      ? "手続きの記録を保存しました。"
      : "記録を残しました。内容を確認したら「確認した」を押しましょう。",
  };
...
const COMPANION_REASON_BY_ACTION: Record<string, string> = {
  "rw-j03-photo":
    "支援制度の申請に備えて、まず被害の記録を確認しましょう",
  "rw-j03-cert-prep":
    "支援制度を利用するために、まず被害の証明を確認しましょう",
  "rw-j04-insurance-report":
    "保険の手続きに備えて、被害の連絡を確認しましょう",
  "rw-j04-loan-relief":
    "住宅ローンの負担を減らせる制度がないか、確認しましょう",
  "rw-j04-life-rebuild":
    "利用できる生活再建支援について、確認しましょう",
  "rw-j04-tax-social":
    "税や社会保険の手続きについて、公式案内を確認しましょう",
  "rw-j05-emergency-repair":
    "雨の前に、屋根の応急・緊急修理（ブルーシート等）を確認しましょう",
  "rw-j04-programs":
    "お住まいの地域で使える支援と、生活再開の確認を進めましょう",
  "rw-j01-welfare-shelter":
    "ご家族の安全のため、避難の選択肢を確認しましょう",
  "rw-j01-family-safety":
    "まずご家族の安全を、確認しましょう",
  "rw-j02-water":
    "給水場所と、水道減免・電気ガスの安全確認を進めましょう",
  "rw-j02-water-station":
    "給水場所と、水道減免・電気ガスの安全確認を進めましょう",
  "rw-j02-water-children":
    "子ども世帯の水の確保と、学校・園の連絡も確認しましょう",
  "rw-j05-housing":
    "住まいの見直しについて、確認しましょう",
  "rw-j04-business-recovery":
    "店舗や事業所の状況について、確認しましょう",
  "rw-j06-business":
    "事業の再開について、確認しましょう",
};
...
const COMPANION_DESCRIPTION_BY_ACTION: Record<string, string> = {
  ...
  "rw-j01-welfare-shelter":
    "ご家族の安全のため、避難の選択肢を確認しましょう。",
  "rw-j02-water-station":
    "給水場所に加え、水道料金の減免と電気・ガスの安全確認も、進めましょう。",
  "rw-j02-water-children":
    "お子さんに必要な水の確保と、学校・園の連絡も確認しましょう。",
  "rw-j03-photo":
    "片付け・修理の前に、安全な場所から被害の記録を残しましょう。",
  "rw-j03-cert-prep":
    "罹災証明の申請に必要な書類を、確認しましょう。",
  "rw-j04-business-recovery":
    "店舗や事業所の状況と、事業者向け支援制度を確認しましょう。",
  "rw-j04-insurance-report":
    "加入している保険への被害連絡を、確認しましょう。",
  "rw-j04-loan-relief":
    "住宅ローンの返済猶予・減免制度について、確認しましょう。",
  "rw-j04-life-rebuild":
    "利用できる生活再建支援について、確認しましょう。",
  "rw-j04-tax-social":
    "税や社会保険の手続きについて、公式案内を確認しましょう。",
  "rw-j04-programs":
    "地域の支援と、仕事・学校・通院の再開について、確認しましょう。",
  "rw-j05-emergency-repair":
    "雨の前に、ブルーシート等の緊急修理と応急修理の案内を、確認しましょう。",
  "rw-j05-temp-housing":
    "住まいの見直しについて、確認しましょう。",
};
...
export function softenSurvivorDisplayText(text: string): string {
  return text
    ...
    .replace(/判断してください/g, "確認しましょう")
    .replace(/判断が必要/g, "確認が大切")
